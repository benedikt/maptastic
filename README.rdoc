...
To install the maptastic gem simply add this line to your Gemfile:

  gem "maptastic", :git => "git://github.com/benedikt/maptastic"
...
To finalize the installation please set your Google Maps API key in config/initializers/maptastic.rb
